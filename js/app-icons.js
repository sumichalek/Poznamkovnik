...
const iconPaths = {
  ...
  'folder-up': ['M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9l-.81-1.2A2 2 0 0 0 7.9 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z', 'M12 17V10', 'm8.5 13.5 3.5-3.5 3.5 3.5'],
  'folder-down': ['M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9l-.81-1.2A2 2 0 0 0 7.9 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z', 'M12 10v7', 'm8.5 13.5 3.5 3.5 3.5-3.5'],
  ...
  'article-check': ['M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z', 'M14 2v6h6', 'm8 17 2 2 4-4'],
  plus: ['M12 5v14', 'M5 12h14'],
  close: ['m18 6-12 12', 'm6 6 12 12'],
  check: ['m5 12 4 4L19 6'],
  save: ['M5 3h12l4 4v14H5Z', 'M8 3v6h8V3', 'M8 21v-7h8v7'],
  pencil: ['M12 20h9', 'M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z'],
  pin: ['M12 17v5', 'M8 3h8l1 7 3 3v2H4v-2l3-3 1-7Z'],
  'pin-off': ['M12 17v5', 'M8 3h8l1 7 3 3v2H4v-2l3-3 1-7Z', 'm3 3 18 18'],
  ...
  'collapse-to-top': ['M5 4H19', 'M12 20V8', 'M8 12L12 8L16 12'],
  ...
  search: ['M21 21l-4.35-4.35', 'M10.8 18a7.2 7.2 0 1 1 0-14.4 7.2 7.2 0 0 1 0 14.4Z'],
  eraser: ['m7 21-4.3-4.3a1 1 0 0 1 0-1.4l9.6-9.6a1 1 0 0 1 1.4 0l7.6 7.6a1 1 0 0 1 0 1.4L15.7 20a1 1 0 0 1-1.4 0L12 20', 'M9.5 13.5 15 19', 'M3 21h12'],
  calendar: ['M7 3v3', 'M17 3v3', 'M4 9h16', 'M5 5h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2Z', 'M8 13h.01', 'M12 13h.01', 'M16 13h.01', 'M8 17h.01', 'M12 17h.01'],
  ...
  'playlist-plus': ['M3 6H12', 'M3 11H12', 'M3 16H9', 'M17 3V13', 'M17 3c1.5.1 2.6.6 4 1.4', 'M14.5 15a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z', 'M19 18v4', 'M17 20h4'],
  ...
  stop: ['M6 6h12v12H6Z'],
  record: ['M12 12h.01', 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Z'],
  music: ['M11 18V4', 'M11 4c4 .1 7 1.4 9 3.5', 'M8 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z'],
  podcast: ['M12 12h.01', 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Z', 'M8.5 8.5a5 5 0 0 0 0 7', 'M15.5 8.5a5 5 0 0 1 0 7'],
  radio: ['M4 16.5a11 11 0 0 1 0-9', 'M7.5 14a7 7 0 0 1 0-4', 'M16.5 14a7 7 0 0 0 0-4', 'M20 16.5a11 11 0 0 0 0-9', 'M12 12h.01'],
  'skip-back': ['M19 20 9 12l10-8v16Z', 'M5 19V5'],
  'skip-forward': ['m5 4 10 8-10 8V4Z', 'M19 5v14'],
  shuffle: ['M16 3H21V8', 'M4 20L21 3', 'M21 16L16 21', 'M4 4L9 9', 'M17 21H21V17'],
  repeat: ['m17 2 4 4-4 4', 'M3 11V9a3 3 0 0 1 3-3h15', 'm7 22-4-4 4-4', 'M21 13v2a3 3 0 0 1-3 3H3'],
  'repeat-1': ['m17 2 4 4-4 4', 'M3 11V9a3 3 0 0 1 3-3h15', 'm7 22-4-4 4-4', 'M21 13v2a3 3 0 0 1-3 3H3', 'M12 10v4', 'm10 11 2-1 2 1'],
  timer: ['M10 2h4', 'M12 14v-4', 'm12 14 3 2', 'M6.2 5.2 4.8 3.8', 'M17.8 5.2l1.4-1.4', 'M21 13a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z'],
  'grip-vertical': ['M9 5h.01', 'M9 12h.01', 'M9 19h.01', 'M15 5h.01', 'M15 12h.01', 'M15 19h.01'],
  'volume-2': ['M11 5 6 9H2v6h4l5 4Z', 'M15.5 8.5a5 5 0 0 1 0 7', 'M19 5a10 10 0 0 1 0 14'],
  opacity: ['M12 3C8.3 7.4 5 10.4 5 14a7 7 0 0 0 14 0c0-3.6-3.3-6.6-7-11Z', 'M8 16a4.5 4.5 0 0 0 8 0'],
  terminal: ['M4 5h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2Z', 'm6 9 3 3-3 3', 'M12 15h5'],
  'rotate-ccw': ['M3 12a9 9 0 1 0 3-6.7', 'M3 4v5h5'],
